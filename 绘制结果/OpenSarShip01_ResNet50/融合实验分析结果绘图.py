...
def draw_fig(avg_perf_up_lst):
    ...
    plt.savefig("./结果图/OpenSarShip_ResNet50_performance_average_lift_histogram.png")
    # plt.show()
...
if __name__ == '__main__':
    ...
    xl = r'/Users/wangpengcheng/PycharmProjects/MStar/绘制论文结果图/绘制结果/OpenSarShip01_ResNet50/' \
