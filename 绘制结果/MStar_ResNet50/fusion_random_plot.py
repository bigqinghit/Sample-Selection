...
def precision(i: int, axs: plt):
    ...
    axs[i].set_yticks([0, 50, 100])  # 设置纵坐标刻度的位置  -- 单位为1
    # 在 0-100 之间
    axs[i].set_yticklabels(['0', '50%', '100%'])
...
if __name__ == '__main__':
    ...
    FUSION_RAW = 41
    RANDOM_RAW = 22
    fig_title = r'MStar_ResNet50'

    # save_prefix = 'MStar_ResNet50_Fusion_vs_Random_'
    save_prefix = 'MStar_ResNet50_RL_vs_Random_'

    root = r'/Users/wangpengcheng/PycharmProjects/MStar/绘制论文结果图/绘制结果/MStar_ResNet50'
    f = r'MStar-resnet50结果汇总.xlsx'
